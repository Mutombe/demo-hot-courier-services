...
const siteData = {
  business: {
    name: "Hot Courier Services",
    legalName: "Hot Courier Services",
    tagline: "Delivering Excellence Across Zimbabwe",
    description: "Founded with a belief that Zimbabwe deserves world-class logistics, Hot Courier Services has grown from a single delivery van into one of Harare's most trusted courier and freight companies.",
    phone: "+263 71 989 2103",
    phoneRaw: "+263719892103",
    whatsappNumber: "263719892103",
    email: "info@hotcourierservices.co.zw",
    address: "Shop 15 Samora Machel Ave, Harare, Zimbabwe",
    country: "Zimbabwe",
    city: "Harare",
    rating: 3.4,
    ratingRounded: 3,
    ...
    cookieConsentKey: "hot-courier-services-cookie-consent",
    socialLinks: { facebook: "", instagram: "#", linkedin: "#" },
  },

  navbar: { logoImage: null, logoLine1: "Hot", logoLine2: "Courier Services" },

  hero: {
    badge: "Harare's Trusted Courier & Logistics Partner",
    titleParts: [
      { text: "DELIVERED " },
      { text: "ON TIME", highlight: true },
      { text: " EVERY TIME." },
    ],
  ...
  homeTestimonials: [
    { text: "We switched to Hot Courier Services six months ago and our delivery complaints dropped to almost zero. The real-time tracking gives our customers confidence.", name: "Tendai Moyo", role: "E-Commerce Director", rating: 5, avatar: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=100&q=80" },
    { text: "Same-day delivery in Harare that actually works. Hot Courier Services has been a game-changer for our pharmacy business.", name: "Rudo Nhemachena", role: "Pharmacy Owner", rating: 5, avatar: "https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=100&q=80" },
    { text: "Reliable, professional, and always on time. Hot Courier Services handles all our corporate logistics and we could not be happier.", name: "James Karanga", role: "Operations Manager", rating: 5, avatar: "https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?w=100&q=80" },
  ...
  about: {
    ...
    story: [
      "Founded with a belief that Zimbabwe deserves world-class logistics, Hot Courier Services has grown from a single delivery van into one of Harare's most trusted courier and freight companies.",
  ...
  reviews: {
    ...
    items: [
      { text: "We switched to Hot Courier Services six months ago and our delivery complaints dropped to almost zero. The real-time tracking gives our customers confidence.", name: "Tendai Moyo", role: "E-Commerce Director", rating: 5 },
      { text: "Same-day delivery in Harare that actually works. Hot Courier Services has been a game-changer for our pharmacy business.", name: "Rudo Nhemachena", role: "Pharmacy Owner", rating: 5 },
      { text: "Reliable, professional, and always on time. Hot Courier Services handles all our corporate logistics and we could not be happier.", name: "James Karanga", role: "Operations Manager", rating: 5 },
      ...
      { text: "Outstanding service from start to finish. Hot Courier Services exceeded all our expectations.", name: "Memory Dube", role: "Satisfied Customer", rating: 5 },
      { text: "Professional, reliable, and great value for money. I recommend Hot Courier Services to everyone.", name: "Tafadzwa Chikumba", role: "Regular Client", rating: 5 },
      { text: "The team at Hot Courier Services is knowledgeable and always willing to go the extra mile.", name: "Chenai Manyika", role: "Business Owner", rating: 5 },
      { text: "Consistently excellent service. Hot Courier Services has been our trusted partner for years.", name: "Patrick Nhamo", role: "Property Manager", rating: 5 },
    ],
  },
  ...
  homeCta: {
    ...
    whatsappText: "Hi Hot Courier Services! I would like to request a quote.",
